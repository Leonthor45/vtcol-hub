          ...
          <div className="space-y-8 p-8">
            ...
            <div className="grid gap-8 lg:grid-cols-[1.4fr_0.8fr]">
              ...
              <section className="rounded-[32px] border border-white/10 bg-slate-950/50 p-8">
                ...
                {/* Clips recientes (si existen) */}
                {vtuber.clips && vtuber.clips.length > 0 && (
                  <div className="mt-10">
                    <h3 className="text-xl font-bold text-white mb-4">🎬 Clips recientes</h3>
                    <div className="grid gap-4 md:grid-cols-2">
                      {vtuber.clips.slice(0, 4).map((clip) => (
                        <div
                          key={clip.id}
